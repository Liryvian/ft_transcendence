...
import { AnimalController } from './backend/src/test_example/animal.controller';
import { AnimalService } from './backend/src/test_example/animal.service';
import { ConfigModule } from '@nestjs/config';
import { TypeOrmModule } from '@nestjs/typeorm';
import { TypeOrmConfigService } from './backend/src/typeorm/typeorm.service';
