...
export class MembershipStateController {
  constructor(private readonly membershipStateService: MembershipStateService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateMembershipStateDto: UpdateMembershipStateDto) {
